...
export class PrivateDomainStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: PrivateDomainStackProps) {
    ...
    new cdk.CfnOutput(this, "AlbDnsName", {
      ...
      description:
        "Internal ALB DNS (publicly resolvable — use as routingDomain)",
    });
    ...
    new cdk.CfnOutput(this, "PrivateDomainAlb", {
      ...
      description:
        "Private domain pointing to ALB (only resolvable inside VPC)",
    });
    ...
    new cdk.CfnOutput(this, "PrivateDomainDirect", {
      ...
      description:
        "Private domain pointing to EC2 IP directly (only resolvable inside VPC)",
    });
